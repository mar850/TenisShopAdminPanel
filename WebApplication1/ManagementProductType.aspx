<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagementProductType.aspx.cs" Inherits="WebApplication1.Management.ManagementProductType" %>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
           ...
           <div class="form-group">
            <label for="usr" id="name_type_label">Nazwa</label>
            <input type="text" class="form-control" runat="server" id="product_name_lineEdit" placeholder="nazwa">
           </div>
          <button type="submit" class="btn btn-default" runat="server" id="add_type_button" >Dodaj</button>
            </form>
            <p></p>
          <label runat="server" id="info_label"></label>
          </div>
        </div>
